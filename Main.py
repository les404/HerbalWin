...
# -------------------- CONFIGURATION --------------------
GEMINI_API_KEY = 'AIzaSyDusA-lDLw_kg_1PJzo6FZY0RtFQGKhkTc' # Note: Keep this key private!
...
class ScannerFrame(ctk.CTkFrame):
    def __init__(self, parent):
        ...
        ctk.CTkLabel(self.result_col, text="AI Analysis Result", font=("Arial", 20, "bold"), text_color="#295222").pack(pady=10)
...
class HistoryFrame(ctk.CTkFrame):
    def __init__(self, parent):
        ...
        ctk.CTkButton(header_frame, text="🔄 Refresh", fg_color="#295222", command=self.refresh_history).pack(side="right")
